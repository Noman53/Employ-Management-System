...
public class systemMethodsTest {
    ...
    public void testAddEmployee() {
      assertEquals(Arrays.asList("1", "Noman", "20","2","John","22","3","Tom","24"), m.AddEmployee());
    }
    ...
    public void testSearchEmployee(){
       ...
       assertEquals(Arrays.asList("1","Noman", "20","2","John","22","3","Tom","24").contains("Noman"), m.SearchEmployee());
